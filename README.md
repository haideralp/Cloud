...
3. Enter the name using same naming convention as the instance as well as the a description to allow ease of identification or in real projects same AMI's may be used many times. Recommended to have two versions one stable and one working in case things go wrong you can roll bacl.  
